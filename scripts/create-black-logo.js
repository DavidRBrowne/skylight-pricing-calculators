...
// Create a black background Sona logo
function createBlackLogoHTML() {
  return `<!DOCTYPE html>
<html>
<head>
    <title>Create Black Background Sona Logo</title>
    <style>
...
<body>
    <h1>Black Background Sona Logo</h1>
    ...
    <script>
        function createBlackLogo(canvasId, size) {
            const canvas = document.getElementById(canvasId);
            const ctx = canvas.getContext('2d');
            
            // BLACK background - definitely won't be white!
        ...
        // Create both logos
        createBlackLogo('logo192', 192);
        createBlackLogo('logo512', 512);
    </script>
</body>
</html>`;
}
...
fs.writeFileSync('black-logo-generator.html', createBlackLogoHTML());

console.log('✅ Created black background Sona logo generator');
console.log('📁 black-logo-generator.html - Open this in your browser');
console.log('');
console.log('🎨 This creates logos with:');
console.log('   - BLACK background (definitely not white!)');
console.log('   - White "SONA" text');
console.log('   - Striped "O" design');
console.log('');
console.log('📱 Instructions:');
console.log('1. Open black-logo-generator.html in your browser');
...
console.log('');
console.log('🚀 This should definitely solve the white icon issue!');
